...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-librarian-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14383&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-librarian-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-librarian` can be installed with:

```
conda install r-librarian
```

It is possible to list all of the versions of `r-librarian` available on your platform with:
